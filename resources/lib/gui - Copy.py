...
class GUI(xbmcgui.WindowXMLDialog):
    ...
    def __parse_shortcut2_aaa(self, item, subElementName):
        subElement = item.find(subElementName)
    ...
    def _parse_shortcut2(self, item):
    ...
    def onClick(self, controlID):
        ...
        if controlID == 405 or controlID == 406 or controlID == 407 or controlID == 408 or controlID == 409 or controlID == 410:
            ...
            import gui
            ui = gui.GUI("script-skinshortcuts.xml", __cwd__, "default", group=launchGroup, groupname=groupName)
            ui.doModal()
            del ui
